...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        insideshadow:
          "inset 6px -6px 7px 0 rgba(0, 0, 0, 0.3), inset -6px 6px 7px 0 rgba(255, 255, 255, 1)",
        buttonshadow:
          "inset 6px 6px 6px 0 rgba(0, 0, 0, 0.3), inset -6px -6px 6px 0 rgba(255, 255, 255, 1)",
        outsideshadow:
          "-6px -6px 7px 0 rgba(255, 255, 255, 1), 6px 6px 7px 0 rgba(0, 0, 0, 0.3)",
      },
      colors: {
